...
(1,'MAIN','C1',10000),(2,'B2','C2',20000),(3,'B3','C3',30000),
(4,'B4','C4',40000),(5,'B5','C5',50000);
SELECT * FROM BRANCH;

INSERT INTO ACCOUNTS(ACCNO,BID,BALANCE) VALUES
(101,'1',1000),(102,'1',2000),
(103,'1',3000),(104,'2',4000),
(105,'2',5000),(106,'3',4000),
(107,'3',3000),(108,'4',2000),
(109,'4',3000),(110,'5',2000),
(111,'5',10000);
...
SELECT CUSTOMER.CID,CUSTOMER_NAME,ACCOUNTS.ACCNO,BRANCH_CITY FROM ACCOUNTS,BRANCH,DEPOSITOR,CUSTOMER 
